<template>
    <div>
        <table style="border: 1px solid; width: 100%">
            <tr>
                <td style="border: 1px solid; padding: 10px;"><label for="address">CURRENT LOCATION </label></td>
                <td style="border: 1px solid; padding: 10px;">
                    <textarea style="width: 100%;" disabled cols="30" rows="3" v-model="initLocation"></textarea>
                </td>
            <tr>
                <td style="border: 1px solid; padding: 10px;"><label for="address">UPDATE NEW LOCATION </label></td>
                <td style="border: 1px solid; padding: 10px;">
...
<script>
    export default {
        data() {
            return {
                initLocation: coverageArea['street'] == null ? null : coverageArea['street'] + ',\n' + coverageArea['area'] + ',\n' + coverageArea['district'] + ',' + coverageArea['state'],
                locations: [
