    ...
    <div>
        <table style="border: 1px solid; width: 100%">
            <tr>
                ...
                <td style="border: 1px solid; padding: 10px;"><input :maxlength=30 style="width: 100%" type="text" id="pet_name" name="pet_name" v-model="donation['pet_name']" required></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="border: 1px solid; padding: 10px;"><label for="contact_info">CONTACT INFO </label></td>
                <td style="border: 1px solid; padding: 10px;">
                    <select style="width: 100%;" id="contact_info" name="contact_info" v-model='contact' required>
