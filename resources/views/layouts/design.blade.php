...
<html lang="en-US" dir="ltr">
  <head>
    ...
    -->
    <!-- Default stylesheets-->
    <link href="{{asset('assets/lib/bootstrap/dist/css/bootstrap.css')}}" rel="stylesheet">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    ...
    =============================================
    -->
    {{-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDwcGe494mppUe1wWq4SuOvTJkKTpe98EI&callback=initMap"></script> --}}
    <script async="" defer="" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCRHCGgD6lswpM35tWzBBH0hHT3BKaDc8c"></script>
    <script src="{{asset('assets/lib/jquery/dist/jquery.js')}}"></script>
    <script src="{{asset('assets/lib/bootstrap/dist/js/bootstrap.js')}}"></script>
