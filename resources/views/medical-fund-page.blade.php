              ...
              @foreach ($ongoing_list as $ongoing_donation)
                <div class="row">
                    <div style="padding: 10px; height:250px; text-align: right;" class="col-sm-3">
                        ...
                        <img style="max-width: 100%; max-height:100%" style="height: 250px" src="{{$url}}" />
                    </div>
                    <div style="padding: 10px; height:250px; text-align: left;" class="col-sm-3">
                        ...
                        @endphp
                        <img style="max-width: 100%; max-height:100%" style="height: 250px" src="{{$url}}" />
                        {{-- <img style="max-width: 100%; max-height:100%" src="{{ url($ongoing_donation->vet_analysis) }}" /> --}}
                    </div>
              ...
              @foreach ($complete_list as $complete_donation)
                <div class="row">
                    ...
                    <div style="padding: 10px; height:250px; text-align: left;" class="col-sm-3">
                        ...
                        @endphp
                        <img style="max-width: 100%; max-height:100%" src="{{$url}}" />
                        {{-- <img style="max-width: 100%; max-height:100%" src="{{ url($complete_donation->vet_analysis) }}" /> --}}
                    </div>
                    <div style="padding: 15px;" class="col-sm-6">
                        <table>
                            <tr>
                            ...
                            @endif
                            <tr>
                                <td style="width: 30%">Total Donation</td>
                                <td>&nbsp;&nbsp;:&nbsp;&nbsp; </td>
                                <td>RM{{$complete_donation->current_amount}}</td>
                            </tr>
                        </table>
                        <br>
